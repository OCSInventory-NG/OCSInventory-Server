...
ALTER TABLE hardware ADD COLUMN CHECKSUM VARCHAR(255);
ALTER TABLE hardware ADD INDEX CHECKSUM (CHECKSUM);
...
INSERT INTO `config` VALUES ('GUI_VERSION', 0, '4011', 'Version of the installed GUI and database');
