...
function auto_duplicate_lvl_poids($value,$entree_sortie){
 ...
 function pageGUI($form_name){
	...
	ligne('DOWNLOAD_PACK_DIR',$l->g(775),'radio',array('DEFAULT'=>$l->g(488)." (".$_SERVER["DOCUMENT_ROOT"]."/DOWNLOAD)",'CUSTOM'=>$l->g(487),'VALUE'=>$select_pack),
		array('HIDDEN'=>'CUSTOM','HIDDEN_VALUE'=>$values['tvalue']['DOWNLOAD_PACK_DIR'],'SIZE'=>70,'END'=>"/DOWNLOAD"));
	ligne('IPDISCOVER_IPD_DIR',$l->g(776),'radio',array('DEFAULT'=>$l->g(488)." (".$_SERVER["DOCUMENT_ROOT"]."/ocsreport/IPD)",'CUSTOM'=>$l->g(487),'VALUE'=>$select_ipd),
